            ...
            with gr.Column(variant='panel'):
                ...
                with gr.Tabs(elem_id="sadtalker_driven_audio"):
                    with gr.TabItem('Upload OR TTS'):
                        ...
                        if False:  # Disabled TTS due to Python 3.12 incompatibility 
...
if __name__ == "__main__":
    ...
    if '--server_name' in sys.argv:
        server_idx = sys.argv.index('--server_name')
        if server_idx + 1 < len(sys.argv):
            server_name = sys.argv[server_idx + 1]

    demo = sadtalker_demo()
    demo.queue()
    demo.launch(server_name=server_name, server_port=port, show_error=True)
